...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: ["Only", "SOAP", "can be used over FTP Only Representation State Transfer (REST) can be used over FTP Representation State Transfer (REST) can be used in combination with SOAP order FTP SOAP and", "Representation State Transfer (REST) can both be implemented over"],
    answer: 3,
  ...
  },
  {
    ...
    answer: 0,
    explanation: "Configurations may be too restrictive",
  },
  {
    id: 1159,
